    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                product p = new product { Customer_ID = int.Parse(txt_number.Text), OrderDate = dateTimePicker1.Value.ToShortDateString(), Product_ID = int.Parse(txt_inventorynumber.Text), Product_Name = txt_objectname.Text, QTY = int.Parse(txt_count.Text), Price = int.Parse(txt_price.Text), isavail = chk_avail.Checked};
                p.save();
